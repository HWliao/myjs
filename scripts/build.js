...
no-use-before-define,prefer-template,global-require,import/no-dynamic-require */
...
const config = process.env.BUILD_TARGET === 'lib' ? require('../config/webpack.config.prod.lib') : require('../config/webpack.config.prod');
